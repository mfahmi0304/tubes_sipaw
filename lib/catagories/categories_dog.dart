...
class CategoriesDogPage extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      children: [
        ...
        Container(
          ...
          child: Align(
            alignment: Alignment.topCenter,
            child: Hero(tag: 1, child: Image.asset('assets/detailDog.png')),
          ),
        ),
        Align(
            ...
            child: Center(
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    "Perawatan Anjing peliharaan sangatlah diperlukan dan sangat penting untuk menjauhkan dari berbagai penyakit hewan",
